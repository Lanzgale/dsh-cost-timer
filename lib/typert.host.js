/**
 * dsh-cost-lite 的 Host 面 Typert 清单(由 typert-loader 自动扫描注册)。
...
export const stateSchema = z.object({
  ...
  // 当日余额基准(零点首次拉取/充值后重置;卡片起始余额条用)。旧快照/未对账时缺失或 null。
  balanceRef: z.object({
    date: z.string(),
    total: num,
    granted: num,
...
const _state$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#CostState', schema: stateSchema }
const _patch$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#ConfigPatch', schema: patchSchema }
const _fetch$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#FetchPricesResult', schema: fetchPricesSchema }
const _provider$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#CodingPlanProvider', schema: z.string() }
const _day$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#DayRecord', schema: daySchema }
const _date$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#DayKey', schema: z.string() }
const _topSessions$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#TopSessions', schema: topSessionsSchema }
const _limit$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#SessionLimit', schema: num }
const _sort$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#SessionSort', schema: z.string() }
const _dir$codec = { mode: 'strict', typeSymbol: 'dsh-cost-lite#SessionSortDir', schema: z.string() }
...
export const TYPERT = {
  ...
  invocations: [
    {
      id: 'dsh-cost-lite#costMeter/getState',
      service: 'costMeter',
      namespace: 'costMeter',
      method: 'getState',
    ...
    {
      id: 'dsh-cost-lite#costMeter/updateConfig',
      service: 'costMeter',
      namespace: 'costMeter',
      method: 'updateConfig',
      invocation: { kind: 'direct' },
    ...
    {
      id: 'dsh-cost-lite#costMeter/fetchPrices',
      service: 'costMeter',
      namespace: 'costMeter',
      method: 'fetchPrices',
      invocation: { kind: 'direct' },
    ...
    {
      id: 'dsh-cost-lite#costMeter/refreshBalance',
      service: 'costMeter',
      namespace: 'costMeter',
    ...
    {
      id: 'dsh-cost-lite#costMeter/resetHistory',
      service: 'costMeter',
      namespace: 'costMeter',
      method: 'resetHistory',
      invocation: { kind: 'direct' },
    ...
    {
      id: 'dsh-cost-lite#costMeter/getDaySessions',
      service: 'costMeter',
      namespace: 'costMeter',
    ...
    {
      id: 'dsh-cost-lite#costMeter/getTopSessions',
      service: 'costMeter',
      namespace: 'costMeter',
  ...
  model: {
    services: [
      {
        description: 'dsh-cost-lite 账本与配置服务(ctx.costMeter),聚合每日模型用量与费用。Ledger and config service (ctx.costMeter) aggregating daily model usage and cost.',
        summary: 'dsh-cost-lite 账本与配置服务 (dsh-cost-lite ledger & config service)。',
        tags: [],
        jsDoc: '/** dsh-cost-lite 账本与配置服务(ctx.costMeter)。dsh-cost-lite ledger & config service (ctx.costMeter). */',
        key: 'costMeter',
