...
const _topSessions$codec = { mode: 'strict', typeSymbol: 'dsh-cost-timer#TopSessions', schema: topSessionsSchema }
const _limit$codec = { mode: 'strict', typeSymbol: 'dsh-cost-timer#SessionLimit', schema: num }
const _sort$codec = { mode: 'strict', typeSymbol: 'dsh-cost-timer#SessionSort', schema: z.string() }
const _dir$codec = { mode: 'strict', typeSymbol: 'dsh-cost-timer#SessionSortDir', schema: z.string() }
...
export const TYPERT = {
  ...
  invocations: [
    ...
    {
      id: 'dsh-cost-timer#costMeter/getTopSessions',
      service: 'costMeter',
      namespace: 'costMeter',
